namespace IEPprojekat.Models
{
    ...
    public partial class User
    {
        ...
        public User()
        {
            AuctionOwner = new HashSet<Auction>();
            AuctionWinner = new HashSet<Auction>();
            Bid = new HashSet<Bid>();
        ...
        public virtual ICollection<Auction> AuctionOwner { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Auction> AuctionWinner { get; set; }
